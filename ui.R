  ...
  tabsetPanel(               
             ...
             fluidRow(
               column(2,
                      radioButtons("L1_Pairwise", label = h4("Comparison"),
                                   choices = c("HC vs WCE","HC vs PCE","PCE vs WCE"),
                                   selected = "HC vs PCE"),
                      hr(),
    ...
    tabPanel("Cell-cell communication with CellChat",
                  ...
                  sidebarLayout(
                    sidebarPanel(
                      radioButtons("composite", h4("Select comparison to visualize for information flow plot"),
                                   choices = list("HC vs WCE", "HC vs PCE", "WCE vs PCE"),
                                   selected = "HC vs WCE"),
             ...
             fluidRow(
               ...
               column(4, h4("WCE"), hr(), plotOutput("CirclePlotWCE")),
               column(4, h4("PCE"), hr(), plotOutput("CirclePlotPCE"))),
